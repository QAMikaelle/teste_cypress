...
describe("Teste - Login", () => {
  ...
  context("Treinamento sem aprovação gestor na turma", () => {
    it.only("Adicionando um documento", () => {
      ...
      cy.get('.ng-pristine.ng-scope > .border').type("Pasta de Teste"); // Digitar nome da pasta
      cy.get('.ng-pristine.ng-scope > .border').type("{enter}"); // Pressionar Enter para criar a pasta
