...
describe("Teste - Login", () => {
  beforeEach(() => {
    ...
    cy.get('[title="Documentos"]').should('be.visible');
    cy.get('[title="Treinamentos"]').should('be.visible'); // Adicionei também para o botão de Treinamentos
});
  ...
  context("Treinamento sem aprovação gestor na turma", () => {
    ...
    it("Criando um treinamento", () => {
      ...
      cy.get("#courseName").type("Teste treinamento 13/06/2025 sem aprovação");
  ...
  context("Treinamento com aprovação gestor na turma", () => {
    ...
    it("Criando um treinamento", () => {
      ...
      //Editar dados
      cy.get("#courseName").click(); // Clica pra digitar
      cy.get("#courseName").type("Teste treinamento 10/06/2025 sem aprovação");
