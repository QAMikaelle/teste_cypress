...
describe("Teste - Login", () => {
  ...
  context("Treinamento sem aprovação gestor na turma", () => {
    it("Adicionando um documento", () => {
      ...
      cy.get('.ng-pristine.ng-scope > .border').type("Pasta de Teste 09.07.2025 1"); // Digitar nome da pasta
  ...
  context("Treinamento com aprovação gestor na turma", () => {
    it.only("Adicionando um documento", () => {
      ...
      //Criar nova pasta  TESTE PARA TREINAMENTO INTEIRO
      cy.get('[title="Documentos"] > .sideitem').click(); // clicar na aba de documentos
      cy.get('[ng-click="showCreateNewFolder();"]').click(); // Botão de criar nova pasta
      ...
      cy.get('.title-bar > .multiselect.ng-pristine > .btn').click(); // Botão de pesquisar pasta
