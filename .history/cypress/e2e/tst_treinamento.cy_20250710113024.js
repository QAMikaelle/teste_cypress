...
describe("Teste - Login", () => {
  ...
  context("Treinamento com aprovação gestor na turma", () => {
    ...
    it.only("Criando um treinamento", () => {
      ...
      cy.get('#cke_803_contents > .cke_wysiwyg_frame').type('Descrição do treinamento'); // Digita a descrição do treinamento
      cy.get('#cke_806_contents > .cke_wysiwyg_frame').type('Resumo do treinamento'); // Digita o resumo do treinamento
      cy.get('[types=""] > .ng-isolate-scope > .multiselect > .border > .ui-select-match > .btn-default').type('testes'); // Digita o tipo de treinamento
      cy.get('#ui-select-choices-row-48-0').click(); // Seleciona o tipo
