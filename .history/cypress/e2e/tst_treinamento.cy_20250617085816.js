...
describe("Teste - Login", () => {
  ...
  context("Treinamento sem aprovação gestor na turma", () => {
    it.only("Adicionando um documento", () => {
      ...
      cy.get('.ng-pristine.ng-scope > .border').type("Pasta de Teste 17.06.2025 4"); // Digitar nome da pasta
      ...
      cy.contains('button', 'Selecionar arquivo').click(); // Botão de upload de arquivo
      cy.get('input[type="file"]').attachFile('documento-teste.pdf'); // Anexar arquivo de teste
      cy.wait(1000);
